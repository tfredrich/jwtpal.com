...
function buildReconstructedPayload(payload, state) {
...
function renderReconstructed(state) {
  const reconstructed = buildReconstructedPayload(state.payload, state);
  update("#disclosures", reconstructed.payload);
